...
import { Direction, format, framerate, Item, Inventory, DirUtils } from "./globals.js";
...
export class DrillTile extends PowerDrainTile {
    ...
    hasConnection(direction) { return true; }
    get tooltip() {
        let land = Map.landAt(this.pos);
        return format(`
      Drill <b>
...
export class ConveyorTile extends PowerDrainTile {
    ...
    tick() {
        ...
        for (let dir of dirs) {
            ...
            if (tile && tile instanceof ConveyorTile && dir == DirUtils.opposite(dir))
                continue;
